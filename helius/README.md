...
当前行情范围已改为新毕业池动态订阅：只在毕业0–30分钟接纳新买入，首次观察到储备<50 SOL后不再接纳；未知储备保留观察但禁止买入。持仓、待确认交易始终保留退出行情。新池发现仍有流量成本，不再保证全市场覆盖。更新后必须按 [动态订阅核对](FRESH-SUBSCRIPTIONS.md) 检查，已有`.env`不会关闭此范围限制。
