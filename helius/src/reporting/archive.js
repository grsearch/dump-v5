...
function publicConfig(c) {
  const keys = ['liveFixedStopLoss', 'liveEntryPolicy', 'calibration', 'dryRun', 'paperPrebuyFilter', 'minSellSol', 'minImpact', 'maxImpact', 'minLiquidity', 'sizeSol', 'maxPositions', 'cooldownMs',
