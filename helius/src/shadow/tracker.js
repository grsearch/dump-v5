...
class Tracker {
  constructor(c, write, { runId = crypto.randomUUID(), now = Date.now } = {}) {
    ...
    this.write({ type: 'session', schema: 1, runId, at: this.now(), policy: this.policy, policyId: this.policyId,
      ...
      freshSubscriptions: c.freshSubscriptions, exitResearchVersion: 5, stateQuoteVersion: this.stateRecovery ? 1 : null, stateQuoteSchedulingVersion: this.stateRecovery ? 3 : null, selectionVersion: 7,
